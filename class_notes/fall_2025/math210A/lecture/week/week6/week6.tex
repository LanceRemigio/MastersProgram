...
\begin{proof}
    \begin{enumerate}
        \item[(1)] (\( \Longleftarrow \)) (We will show that the operation defined above is well-defined)  To show that the operation is well-defined, we need to show that 
    \[  (ab)N = ({a}_{1}{b}_{1})N. \]
    ...
    (\( \Longrightarrow \)) This direction is left for the reader to prove.
        \item[(2)] This is left for the reader to prove.
    \end{enumerate} 
