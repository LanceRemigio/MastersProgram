...
\[ ({g}_{1}{g}_{2}) = ({g}_{1}' {g}_{2}') H. \tag{*}  \]
Since \( H  \) is normal, (that is, \( {g}_{1}' H = H {g}_{2}' \))
\begin{align*}
    {g}_{1}' {g}_{2}' H  = {g}_{1}' H {g}_{2}' &= {g}_{1} H {g}_{2}' \tag{\( {g}_{1}' H = {g}_{1} H  \)} \\
                                               &= {g}_{1} {g}_{2}'  H \tag{\( H \trianglelefteq G \implies H {g}_{1}' = {g}_{2}' H  \)} \\
...
By studying quotient groups of a group, which is a sense organize the group's elements into simpler chunks, we can again valuable information about the group itself. For example, we can show that if \( G / Z(G) \) is cyclic, then \( G  \) is abelian (where \( Z(G) \) is the center of \( G  \)).

Every time we have a homomorphism and we look at the kernel of said homomorphism, they will always be normal subgroups.

\begin{remark}[Observation]
   Suppose \( G  \) is a Lie group and \( N \) is a normal subgroup algebraic subgroup of \( G  \). Thus, \( G / N   \) will be a new algebraic group. The question is: 
   \begin{center}
...
We can we conclude from this result? If we manage to find a smooth structure on \( G / N  \) that ensures \( \pi : G \to G / N   \) is smooth, then \( N  \) is necessarily a topologically closed subset of \( G  \). If it is not closed, then there is no way to define a smooth structure on the homomorphism \( \pi \).
...
\begin{eg}[\( \R / \Z  \)]
   ...
   \[  F : \R / \Z \to S^{1} = \text{U}(1)  \ \ x + \Z \mapsto e^{2\pi i x}  \]
   ...
   \[  \R^{n} / \Z^{n} \cong (S^{1}) \times \cdots (S^{1}) \ \ \tag{\( n  \)-dimensional torus} \]
