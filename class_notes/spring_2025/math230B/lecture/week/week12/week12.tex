...
\begin{theorem}[(Rudin 7.13) Dini's Theorem]\label{Dini's Theorem}
...
\begin{theorem}[The Arzela-Ascoli Theorem]\label{The Arzela-Ascoli Theorem}
...
\begin{definition}[Equicontinuous Sequence of Functions]\label{Equicontinuous sequence of functions}
