...
\begin{theorem}[Mean Value Theorem for Integrals]\label{Mean Value Theorem and Generalize }
...
\begin{theorem}[Additivity for R.S Integrals]\label{Additivity for R.S integrals}
